@extends('layouts.app')
@section('title','Offline Person Information')
@section('css')
      ...
      <div class="container-fluid">
        <div class="content-wrapper bg-light">
          <div class="page-header">
            <h2 class="page-title p-3 row">
              <div class="col-md-6">
                <span class="page-title-icon bg-gradient-primary me-2">
                  <i class="mdi mdi-account-multiple"></i>
                </span><span class="fs-4">Offline Person Informations</span>
              </div>
            ...
            <div class="col-12 grid-margin">
                <div class="container-fluid">
                  ...
                  <div class="table-responsive">
                    <table class="table table-bordered table-striped" style="white-space: nowrap" id="offlinePersonInformationTable">
                      <thead>
                        <tr>
                          <th> No </th>
                          <th> Person Code </th>
...
@push('script')
    ...
    <script>
      $(document).ready( function () {
        $('#offlinePersonInformationTable').DataTable();
      });
    </script>
@endpush